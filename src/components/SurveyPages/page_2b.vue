<template>
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <img
        :src="require('../../assets/Free Response/Rank_02.png')"
...
export default {
  ...
  data() {
    return {
      page_num: "2",
      form: {optn_2_1: "", optn_2_2: "", optn_2_3: "", optn_2_4: ""},
  ...
  methods: {
    go_to_next() {
      if (this.form.optn_2_1 != this.form.optn_2_2 && 
        this.form.optn_2_1 != this.form.optn_2_3 &&
        this.form.optn_2_1 != this.form.optn_2_4 &&
        this.form.optn_2_2 != this.form.optn_2_3 &&
        this.form.optn_2_2 != this.form.optn_2_4 &&
        this.form.optn_2_3 != this.form.optn_2_4) {
