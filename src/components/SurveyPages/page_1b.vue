<template>
  ...
  >
    <b-container class="align-bottom" :style="this.windowsize">
      <img
        :src="require('../../assets/Free Response/Rank_01.png')"
...
export default {
  ...
  data() {
    return {
      page_num: "1",
      form: {optn_1_1: "", optn_1_2: "", optn_1_3: "", optn_1_4: ""},
  ...
  methods: {
    go_to_next() {
      if (this.form.optn_1_1 != this.form.optn_1_2 && 
        this.form.optn_1_1 != this.form.optn_1_3 &&
        this.form.optn_1_1 != this.form.optn_1_4 &&
        this.form.optn_1_2 != this.form.optn_1_3 &&
        this.form.optn_1_2 != this.form.optn_1_4 &&
        this.form.optn_1_3 != this.form.optn_1_4) {
