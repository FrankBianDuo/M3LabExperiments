    ...
    <b-container class="bv-example-row" :style="this.windowsize">
      ...
      >
        ...
        <img
          ...
          "
          style="position: absolute; max-width: 6.0%; max-height: auto; left: 51.6%; top: 24.7%;"
        />
        <img :src="require(`../assets/Avatars/Avatar Eyes/Eyes 90.png`)" style="position: absolute; max-width: 6.0%; max-height: auto; left: 51.6%; top: 24.7%;" />
      ...
      >
        ...
        <img
          :src="
            require(`../assets/Avatars/Blind Avatars/avb${this.pad(324-
              this.avatar_list[this.current_avatar],
              4
            )}.png`)
          "
        ...
        <img
          ...
          "
          style="position: absolute; max-width: 6.0%; max-height: auto; left: 59.5%; top: 24.7%;"
        />
        <img :src="require(`../assets/Avatars/Avatar Eyes/Eyes 90.png`)" style="position: absolute; max-width: 6.0%; max-height: auto; left: 59.5%; top: 24.7%;" />
      ...
      <b-form>
        <b-form-group id="input-group-1" label-for="input-1" style="marginTop: 38.85%" label="Dissimilar ---------------------------------------------------------------------------------------------------------------------------------------------------- Similar">
          <b-input-group>
            <b-form-input
              id="input-group-1"
...
export default {
  ...
  data() {
    return {
      ...
      // ^^^^^
      avatar_1:
        "position: absolute; max-width: 6.0%; max-height: auto; left: 18.8%; top: 50.7%;",
      avatar_2:
        "position: absolute; max-width: 6.0%; max-height: auto; left: 51.4%; top: 50.7%;",
